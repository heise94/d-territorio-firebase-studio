...
export function MobileBottomNav() {
    ...
    if (isLoadingPermissions) {
        return (
             <footer className="fixed bottom-0 left-0 right-0 z-40 h-[73px] border-t bg-background/95 backdrop-blur-sm md:hidden" />
        );
    }
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                "flex-shrink-0 w-20 h-16", // Fixed width and height
                                isActive
