...
import { Loader2, MapPin, Users, MountainSnow, CheckCircle, PlusCircle, Compass } from "lucide-react";
...
const MOCK_TERRITORY_SUGGESTIONS: AdditionalTerritoryInfo[] = [
  { id: "T-ADD1", name: "Residencial Las Flores (Parcial)", number: "105B", type: "urban", mapImageUrl: "https://placehold.co/300x200.png?text=Flores+Parcial", totalBlocks: 6, dataAiHint: "residential map" },
  { id: "T-ADD2", name: "Vereda El Encanto (Parcial)", type: "rural", mapImageUrl: "https://placehold.co/300x200.png?text=Encanto+Rural", totalBlocks: 3, dataAiHint: "rural road" },
  { id: "T-ADD3", name: "Centro Comercial (Completo)", number: "201A", type: "urban", mapImageUrl: "https://placehold.co/300x200.png?text=Centro+Comercial", totalBlocks: 2, dataAiHint: "city center" },
];
              ...
              {suggestedTerritories.map((terr) => (
                <Card key={terr.id} className="hover:shadow-lg transition-shadow flex flex-col">
                  ...
                  <CardContent className="flex-grow space-y-2 text-xs">
                    ...
                    <p><span className="font-medium">Manzanas:</span> {terr.totalBlocks || 'N/A'}</p>
                    {/* <p><span className="font-medium">Estado:</span> {terr.type === 'partial' ? 'Parcialmente trabajado' : 'Completo disponible'}</p> */}
                  </CardContent>
