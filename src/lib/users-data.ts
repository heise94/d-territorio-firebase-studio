...
const normalizeEmail = (name: string, surname: string) => {
    ...
    const normalizedSurname = surname.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "");
...
export const usersToImport = [
    ...
    { name: "Juan Fuentes hijo", email: normalizeEmail("Juan", "Fuenteshijo"), phoneNumber: "", role: USER_ROLES.PUBLICADOR as UserRole },
